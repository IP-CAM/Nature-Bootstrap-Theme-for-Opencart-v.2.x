                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab-customer">
					  ...
					  <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-lastname"><?php echo $entry_fathername; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="fathername" value="<?php echo $fathername; ?>" placeholder="<?php echo $entry_fathername; ?>" id="input-fathername" class="form-control" />
					  ...
					  <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-birth_date"><?php echo $entry_birth_date; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="birth_date" value="<?php echo $birth_date; ?>" placeholder="<?php echo $entry_birth_date; ?>" id="input-birth_date" class="form-control" />
                          <?php if ($error_birth_date) { ?>
                          <div class="text-danger"><?php echo $error_birth_date; ?></div>
                          <?php  } ?>
                        </div>
                      </div>
                      <div class="form-group">
