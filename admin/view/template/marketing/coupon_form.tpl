            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <label class="radio-inline">
                    <?php if ($logged==3) { ?>
                    <input type="radio" name="logged" value="3" checked="checked" />
                    <?php echo "для незарегестрированых"; ?>
                    <?php } else { ?>
                    <input type="radio" name="logged" value="3" />
                    <?php echo "для незаргестрированых"; ?>
                    <?php } ?>
                  </label>
                </div>
              </div>
