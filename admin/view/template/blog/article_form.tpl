      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-article" class="form-horizontal">
          <ul class="nav nav-tabs">
			...
			<?php /* fix_9 */?>
			<li class=""><a href="#tab-data" data-toggle="tab" aria-expanded="false">Данные</a></li>
			<?php /* fix_9 */?>
          </ul>
          <div class="tab-content">
			...
			<div class="tab-pane" id="tab-data">
				  ...
				  <div class="form-group">
					<label class="col-sm-2 control-label" for="input-keyword"><span data-toggle="tooltip" title="">SEO</span></label>
					<div class="col-sm-10">
