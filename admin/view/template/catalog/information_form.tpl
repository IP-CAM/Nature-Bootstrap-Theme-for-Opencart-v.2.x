        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-information" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-neytral"><span data-toggle="tooltip" title="<?php echo $help_neytral; ?>"><?php echo $entry_neytral; ?></span></label>
                  <div class="col-sm-10">
                    <div class="checkbox">
                      <label>
                        <?php if ($neytral) { ?>
                        <input type="checkbox" name="neytral" value="1" checked="checked" id="input-neytral" />
                        <?php } else { ?>
                        <input type="checkbox" name="neytral" value="1" id="input-neytral" />
                        <?php } ?>
                        &nbsp; </label>
                    </div>
                  </div>
