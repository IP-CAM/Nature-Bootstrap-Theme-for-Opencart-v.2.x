        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
  <label class="col-sm-2 control-label" for="input-related-article"><span data-toggle="tooltip" title="<?php echo $help_related_article; ?>"><?php echo $entry_related_article; ?></span></label>
  <div class="col-sm-10">
    <input type="text" name="related-article" value="" placeholder="<?php echo $entry_related_article; ?>" id="input-related-article" class="form-control" />
    <div id="product-related-article" class="well well-sm" style="height: 150px; overflow: auto;">

      <?php foreach ($product_related_articles as $product_related_article) { ?>
      <div id="product-related-article<?php echo $product_related_article['article_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_related_article['name']; ?>
