...
$_['entry_directory']   = 'Adresář';
$_['entry_filename']    = 'Název souboru';
$_['entry_status']      = 'Stav';
$_['entry_sort_order']  = 'Pořadí';

// Help
$_['help_code']         = 'Příklad: en. Něměňte, pokud se jedná o výchozí jazyk.';
$_['help_locale']       = 'Příklad: en_US.UTF-8,en_US,en-gb,en_gb,english';
$_['help_image']        = 'Příklad: gb.png';
$_['help_directory']    = 'Název adresáře, kde jsou umístěny soubory s překladem (pozor na velká a malá písmena)';
$_['help_filename']     = 'Hlavní soubor jazyka (bez koncovky)';
...
$_['error_image']       = 'Název obrázku musí obsahovat 3 až 64 znaky!';
$_['error_directory']   = 'Požadován adresář!';
$_['error_filename']    = 'Název souboru musí obsahovat 3 až 64 znaky!';
