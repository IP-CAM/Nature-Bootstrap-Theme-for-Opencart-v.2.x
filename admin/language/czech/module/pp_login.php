<?php
// Heading
$_['heading_title']        = 'Přihlášení pomocí PayPal';

//Text
$_['text_module']          = 'Moduly';
$_['text_success']         = 'Úspěch: Byl upraven modul Přihlášení pomocí PayPal!';
$_['text_edit']            = 'Upravit modul Přihlášení pomocí PayPal';
$_['text_button_grey']     = 'Šedá';
$_['text_button_blue']     = 'Modrá (Doporučeno)';

//Entry
$_['entry_client_id']      = 'Číslo klienta';
$_['entry_secret']         = 'Tajné';
$_['entry_sandbox']        = 'Sandbox režim';
$_['entry_debug']          = 'Protokolovat chyby';
$_['entry_customer_group'] = 'Skupina zákazníků';
$_['entry_button']         = 'Barva tlačítka';
$_['entry_seamless']       = 'Allow "Seamless Checkout"';
$_['entry_locale']         = 'Jazyk';
...
//Error
$_['error_permission']     = 'Varování: Nemáte oprávnění upravovat modul Přihlášení pomocí PayPal!';
