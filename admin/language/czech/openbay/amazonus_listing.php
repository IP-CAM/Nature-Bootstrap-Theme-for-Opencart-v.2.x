...
$_['button_list'] 					= 'Seznam on Amazon';
...
$_['text_saved_local'] 				= 'Seznaming saved but not uploaded yet';
...
$_['text_edit_heading'] 			= 'Upravit listing';
...
$_['entry_to'] 						= 'Date to';
$_['entry_product'] 				= 'Seznaming for product';
$_['entry_category'] 				= 'Amazon category';

//Tabs
$_['tab_main'] 						= 'Main';
$_['tab_required'] 					= 'Required info';
$_['tab_additional'] 				= 'Přidatitional options';
...
$_['error_connecting'] 				= 'Varování: There was problem connecting to the API. Please check your OpenBay Pro Amazon extension settings. If the problem persists, please contact support.';
$_['error_required'] 				= 'This field is required!';
$_['error_not_saved'] 				= 'Seznaming was not saved. Check your input.';
$_['error_char_limit'] 				= 'znaky over limit.';
