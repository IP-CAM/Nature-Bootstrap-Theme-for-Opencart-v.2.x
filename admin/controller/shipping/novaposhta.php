...
class ControllerShippingNovaposhta extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['novaposhta_total'])) {
			$data['novaposhta_total'] = $this->request->post['novaposhta_total'];
		} else {
			$data['novaposhta_total'] = $this->config->get('novaposhta_total');
		}
