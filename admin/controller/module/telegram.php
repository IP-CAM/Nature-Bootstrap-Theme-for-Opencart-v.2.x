...
class ControllerModuleTelegram extends Controller {
	...
	public function index() {
		...
		if (isset($this->error[''])) {
			$data['error_name'] = $this->error['bot_name'];
		} else {
			$data['error_name'] = '';
		}
		...
		if (isset($this->request->post['bot_name'])) {
			$data['bot_name'] = $this->request->post['bot_name'];
		} elseif (!empty($module_info)) {
			$data['bot_name'] = $module_info['bot_name'];
		} else {
			$data['bot_name'] = '';
		}
	...
	protected function validate() {
		...
		if ((utf8_strlen($this->request->post['bot_name']) < 3) || (utf8_strlen($this->request->post['bot_name']) > 64)) {
			$this->error['bot_name'] = $this->language->get('error_bot_name');
		}
