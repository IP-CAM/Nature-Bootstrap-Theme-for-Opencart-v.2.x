...
class ControllerCatalogProduct extends Controller {
	...
	$this->load->model('blog/article');
		...
		if (isset($this->request->post['product_related_article'])) {
			...
			$articles = $this->model_catalog_product->getProductRelatedArticle($this->request->get['product_id']);
		} else {
			$articles = array();
		}

		$data['product_related_articles'] = array();

		foreach ($articles as $article_id) {
			$related_article_info = $this->model_blog_article->getArticle($article_id);
