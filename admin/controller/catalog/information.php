...
class ControllerCatalogInformation extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_top'] = $this->language->get('entry_top');		//added for info in main menu
		$data['entry_neytral'] = $this->language->get('entry_neytral');		//added for neytral info
		...
		$data['help_top'] = $this->language->get('help_top');	//added for info in main menu
		$data['help_neytral'] = $this->language->get('help_neytral');		//added for neytral info
		...
		if (isset($this->request->post['top'])) {		//added for info in main menu
		...
		if (isset($this->request->post['neytral'])) {		//added for neytral info
			$data['neytral'] = $this->request->post['neytral'];
		} elseif (!empty($information_info)) {
			$data['neytral'] = $information_info['neytral'];
		} else {
			$data['neytral'] = 0;
		}
