...
class ControllerSaleOrder extends Controller {
	...
	public function getForm() {
		...
		if (!empty($order_info)) {
			...
			$data['birth_date'] = $order_info['birth_date'];
			$data['fathername'] = $order_info['fathername'];
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['text_fathername'] = $this->language->get('text_lastname');
			$data['text_birth_date'] = $this->language->get('text_lastname');
