...
class ControllerSaleCustomer extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->error['fathername'])) {
			$data['error_fathername'] = $this->error['fathername'];
		} else {
			$data['error_fathername'] = '';
		}
		if (isset($this->error['birth_date'])) {
			$data['error_birth_date'] = $this->error['birth_date'];
		} else {
			$data['error_birth_date'] = '';
		}
		...
		if (isset($this->request->post['fathername'])) {
			$data['fathername'] = $this->request->post['fathername'];
		} elseif (!empty($customer_info)) {
			$data['fathername'] = $customer_info['fathername'];
		} else {
			$data['fathername'] = '';
		}
		if (isset($this->request->post['birth_date'])) {
			$data['birth_date'] = $this->request->post['birth_date'];
		} elseif (!empty($customer_info)) {
			$data['birth_date'] = $customer_info['birth_date'];
		} else {
			$data['birth_date'] = '';
		}
