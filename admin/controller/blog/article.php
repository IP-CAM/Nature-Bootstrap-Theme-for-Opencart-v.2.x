...
class ControllerBlogArticle extends Controller {
	...
	protected function getList() {
		...
		if (isset($this->request->get['article_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$information_info = $this->model_blog_article->getArticle($this->request->get['article_id']);
		}
	...
	protected function getForm() {
		...
		//fix_9
		if (isset($this->request->get['article_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$information_info = $this->model_blog_article->getSEOInformation($this->request->get['article_id']);
		}
