...
$_['help_issue']				= '(for Maestro a Solo cards only)';
...
$_['text_address_yyy']			= 'Card Issuer confirmed that street a postcode match with their records';
...
$_['text_address_nnn']			= 'Both street a postcode do not match with the Card Issuer records';
...
$_['text_card_code_blank']		= 'A blank response should indicate that no code was sent a that there was no indication that the code was not present on the card.';
