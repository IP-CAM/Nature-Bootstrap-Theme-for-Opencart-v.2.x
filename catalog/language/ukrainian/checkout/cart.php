...
$_['text_next']        = '<span style="color:blue">Як отримакти знижку до 50%?</span>';
$_['text_next_choice'] = '1) ЗАРЕЄСТРУЙТЕСЯ за посиланням - <a href="http://www.tjanshi.com/login" target="_blank" class="blue-link"> http://www.tjanshi.com/login</a>
<br> 2) Після реєстрації - Ви отримаєте «Купон на ЗНИЖКУ» 
<br>3) Застосуйте Ваш "Купон на ЗНИЖКУ" (детальніше дивіться в <a href="http://www.tjanshi.com/kak-vospolzovatsja-kuponom-na-skidku.html" target="_blank" class="blue-link">ПОКРОКОВІЙ ІНСТРУКЦІЇ</a>)';
