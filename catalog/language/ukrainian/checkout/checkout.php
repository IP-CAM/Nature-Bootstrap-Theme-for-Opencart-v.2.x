...
$_['text_returning_customer']        = 'Якщо Ви вже реєструвалися і заповнювали свої дані - ';
$_['text_checkout']                  = 'Опції оформлення замовлення:';
$_['text_i_am_returning_customer']   = '<span class="blue-link">пройдіть Авторизацію</span>';
...
$_['text_month']                     = 'місяць';
$_['text_year']                      = 'рік';
$_['oferta']	= 'Згоден з <a href="http://www.tjanshi.com/publichnaya-oferta.html" target="_blank" class="blue-link">офертою</a>';
...
$_['error_fathername']                = 'По батькові повинно містити від 1 до 32 символів!';
