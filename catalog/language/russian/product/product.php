...
$_['text_related_article']                    = 'Рекомендуемые cтатьи';
$_['text_all_articles']                       = 'Все cтатьи';
...
$_['text_year']                               = 'год';
$_['text_sertificates']						  = '';
$_['text_buy_stock']						  = 'Цена по акции';
$_['text_sertificates_short']				  = 'Cертификаты';
$_['text_price']							  = 'Цена: ';
$_['text_russia_only']				= 'Предложение действительно только для России';
$_['all_products'] = 'Весь каталог продукции Тяньши';
$_['text_skidki'] = 'Получить СКИДКУ';
$_['text_reviews_my'] = 'Отзывы';
