...
<div class="mod_carusel">
	<h2 class="feed-items"><a href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a></h2>
	<div id="mod_feed_items<?php echo $category['category_id']; ?>" class="row owl-carousel owl-theme" >
