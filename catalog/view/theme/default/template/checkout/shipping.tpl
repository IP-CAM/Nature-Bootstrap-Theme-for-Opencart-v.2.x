<div class="panel panel-default">
  ...
  <div id="collapse-shipping" class="panel-collapse collapse">
    <div class="panel-body">
	  ...
	  <label>После 27000 рублей в корзине доставка беслатная!</label>
...
$('#button-quote').on('click', function() {
	$.ajax({
		...
		type: 'post',
		data: 'country_id=' + $('select[name=\'country_id\']').val() + '&zone_id=' + $('select[name=\'zone_id\']').val() + '&postcode=' + encodeURIComponent($('input[name=\'postcode\']').val()) + '&city=' + $('select[name=\'city\']').val(),
		dataType: 'json',
		beforeSend: function() {
		...
		success: function(json) {
			...
			if (json['shipping_method']) {
				...
				html  = '<div id="modal-shipping" class="modal" style="display: hidden">';
					...
					if (!json['shipping_method'][i]['error']) {
						for (j in json['shipping_method'][i]['quote']) {
							...
							if (json['shipping_method'][i]['quote'][j]['code'] == '<?php echo $shipping_method; ?>') {
								...
								html += '<input type="radio" checked="checked" name="shipping_method" value="' + json['shipping_method'][i]['quote'][j]['code'] + '" />';
							}
				...
				html += '        <input type="button" value="<?php echo $button_shipping; ?>" id="button-shipping" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary mod-btn" />';
				<?php } else { ?>
				html += '        <input type="button" value="<?php echo $button_shipping; ?>" id="button-shipping" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary mod-btn" />';
				<?php } ?>
