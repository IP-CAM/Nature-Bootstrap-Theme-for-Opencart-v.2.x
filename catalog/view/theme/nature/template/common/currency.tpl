...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="currency">
  <div class="btn-group">
    ...
    <button class="btn btn-link dropdown-toggle" data-toggle="dropdown" style="font-size: 1.6em; border-bottom: 1px solid;">
    <?php }else{ ?>
    ...
    <?php } ?>
    <?php } ?>
    <span class="hidden-xs"><?php echo $text_currency; ?></span> <i class="fa fa-caret-down"></i></button>
