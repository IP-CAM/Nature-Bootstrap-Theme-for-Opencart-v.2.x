<div class="list-group">
  ...
  <?php if ($logged) { ?>
  <a href="<?php echo $edit; ?>" class="list-group-item"><?php echo $text_edit; ?></a>  <a href="<?php echo $editgroup; ?>" class="list-group-item"><?php echo $text_editgroup; ?></a> <a href="<?php echo $password; ?>" class="list-group-item"><?php echo $text_password; ?></a>
  <?php } ?>
