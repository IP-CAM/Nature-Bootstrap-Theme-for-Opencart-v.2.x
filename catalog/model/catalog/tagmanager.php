 ...
 * $date: 29 Sep 2017
*******************************************************/
class ModelCatalogTagmanager extends Model {
	...
	public function getTagmanger() {
		...
		$tagmanager = array (
			'code' 	           => $this->config->get('tagmanager_code'),
		  'status'           => $this->config->get('tagmanager_status'),
		  'admin'            => $this->config->get('tagmanager_admin'),
		  'eu_cookie'        => $this->config->get('tagmanager_eu_cookie'),
	    'cookie_text'      => $this->config->get('tagmanager_cookie_text'),
		  'cookie_link'      => $this->config->get('tagmanager_cookie_link'),
			'cookie_button1'   => $this->config->get('tagmanager_cookie_button1'),
			'cookie_button2'   => $this->config->get('tagmanager_cookie_button2'),
		  'adword'           => $this->config->get('tagmanager_adword'),
		  'conversion_id'    => $this->config->get('tagmanager_conversion_id'),
		  'conversion_label' => $this->config->get('tagmanager_conversion_label'),
		  'remarketing'      => $this->config->get('tagmanager_remarketing'),
		  'pixel'					   => $this->config->get('tagmanager_pixel'),
		  'pixelcode'			   => $this->config->get('tagmanager_pixelcode'),
		  'pmap'						 => $this->config->get('tagmanager_product'),
  ...
  public function tagmangerPmap($model='',$sku='',$product_id='') {
    ...
    return htmlspecialchars($ptitle, ENT_QUOTES,'UTF-8');
  }
