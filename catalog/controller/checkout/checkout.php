...
class ControllerCheckoutCheckout extends Controller { 
	...
	public function foo(){
		...
		//$this->session->data['shipping_method']['code'] = "novaposhta";
		$data_for_calc = array();
		...
		file_put_contents('country-zone.txt', serialize($data_for_calc));
		$this->load->model('shipping/novaposhta');
		$quote = $this->model_shipping_novaposhta->getQuote($data_for_calc);
	...
	//	$this->shipping_calc($data_for_calc);
		//$this->cart(false);
		...
		{ 
			...
			$data['fathername'] = $this->customer->getFathername();
	...
	public function guest_validate() {
		...
		if ($data['opencart2'])
		{
			...
			if (!$json) {
				if (!is_numeric(strtotime($this->request->post['birth_date']))) {			
					$json['error']['birth_date'] = $this->language->get('error_birth_date');
				}
				
				else
				{
					$date = strtotime($this->request->post['birth_date']);
					if (time() - $date < 31536000*18)
						$json['error']['birth_date'] = "Вам должно быть больше 18 лет";
				}
				if (!isset($this->request->post['politika'])) {			
					$json['error']['politika'] = "Чтоб оформить заказ Вы должны согласиться";
				...
				if (isset($this->request->post['fathername']) && ((utf8_strlen(trim($this->request->post['fathername'])) < 1) || (utf8_strlen(trim($this->request->post['fathername'])) > 32))) {
					$json['error']['fathername'] = $this->language->get('error_fathername');
				}
				...
				{
					if ($this->request->post['country_id'] == 220) //Украина
					{
						if ($this->request->post['city5'] == '' or $this->request->post['city5'] == '0') {
							$json['error']['city'] = "Пожалуйста, введите город";
						}
						//$this->request->post['city']=$this->request->post['city5'];
					}
					else
						// c_fix_2
						//if ($this->request->post['city'] == '' or $this->request->post['city'] == '0') {
						if ($this->request->post['city'] == '' or $this->request->post['city'] == '0') {	
			...
			if (!$json) {
				...
				$this->session->data['guest']['fathername'] = $this->request->post['fathername'];
				...
				$this->session->data['payment_address']['fathername'] = $this->request->post['fathername'];
				...
				if ($this->session->data['guest']['shipping_address'] || $this->session->data['shipping_address']) {
					...
					$this->session->data['shipping_address']['fathername'] = $this->request->post['fathername'];
	...
	//			unset($this->session->data['payment_methods']);
		...
		} else 
		{
			...
			if (!$json) {
				...
				if (isset($this->request->post['fathername']) && ((utf8_strlen($this->request->post['fathername']) < 1) || (utf8_strlen($this->request->post['fathername']) > 32))) {
					$json['error']['fathername'] = $this->language->get('error_fathername');
				}
				...
				if (!isset($this->request->post['city']) || $this->request->post['city'] == '' || $this->request->post['city'] == '0') {
					$json['error']['city']  = $this->language->get('error_city');;
					//$json['error']['zone_id'] = $this->language->get('error_zone');
				}	
			}
			...
			if (!$json) {
				...
				$this->session->data['guest']['payment']['fathername'] = $this->request->post['fathername'];
				...
				if ($this->session->data['guest']['shipping_address']) {
					...
					$this->session->data['guest']['shipping']['fathername'] = $this->request->post['fathername'];
	...
	public function register_validate(&$data = array()) 
	{
		...
		if (!$json) {	
			...
			if (!isset($this->request->post['city']) or $this->request->post['city'] == '' or $this->request->post['city'] == '0') {
					$json['error']['city'] = $this->language->get('error_city');
				}
	...
	public function shipping_address_validate(&$data = array()) {
		...
		if (!$json) {
			...
			if (isset($this->request->post['shipping_address']) && $this->request->post['shipping_address'] == 'new') { 
				...
				if ((utf8_strlen($this->request->post['shipping_fathername']) < 1) || (utf8_strlen($this->request->post['shipping_fathername']) > 32)) {
					$json['error']['shipping_fathername'] = $this->language->get('error_fathername');
				}
				...
				if (!isset($this->request->post['shipping_city']) or $this->request->post['shipping_city'] == '' or $this->request->post['shipping_city'] == '0') {
...
//				error_log(print_r($this->session->data['payment_methods'],1));
	...
	public function shipping_address($render = true, &$data  = array()) {
		...
		$data['entry_fathername'] = $this->language->get('entry_fathername');
	...
	public function checkout($render = true, &$data  = array()) 
	{
		...
		$this->document->addScript('catalog/view/javascript/jquery/maskedinput/jquery.maskedinput.js');
  	...
  	public function guest($render = false, &$data  = array()) {
		...
		$data['entry_fax1'] = $this->language->get('entry_fax1');
		$data['entry_company'] = $this->language->get('entry_company');
		...
		if (isset($this->session->data['guest']['fathername'])) {
			$data['fathername'] = $this->session->data['guest']['fathername'];
		} else {
			$data['fathername'] = '';
		}
		...
		if ($opencart2) 
		{
			...
			if (isset($_POST) && !empty($_POST))
			{
				if ($this->customer->isLogged()) {
					...
					$order_data['fathername'] = $customer_info['fathername'];
					...
					$order_data['fathername'] = isset($this->session->data['guest']['fathername'])?$this->session->data['guest']['fathername']:'';
				...
				if ((isset($payment_address) && is_array($payment_address)) || isset($this->session->data['payment_address']))
				{
						...
						$order_data['payment_fathername'] = $payment_address['fathername'];
				...
				if ($this->cart->hasShipping()) {
					if(!$this->customer->isLogged())
					{
						...
						else
						{
							...
							$order_data['shipping_fathername'] = $this->request->post['shipping_fathername'];
					...
					if (isset($this->request->post['shipping_firstname']))
					{
						...
						else
						{
							if(isset($this->session->data['shipping_address_id']))
							{
								...
								$order_data['shipping_fathername'] = $shipping_address['fathername'];
							...
							else
							{
								...
								$this->session->data['shipping_address']['lastname'] = $this->request->post['lastname'];
								$this->session->data['shipping_address']['company'] = $this->request->post['company'];
								$this->session->data['shipping_address']['birth_date'] = $this->request->post['birth_date'];
								$this->session->data['shipping_address']['address_1'] = $this->request->post['address_1'];
								$this->session->data['shipping_address']['address_2'] = $this->request->post['address_2'];
								$this->session->data['shipping_address']['postcode'] = $this->request->post['postcode'];
								$this->session->data['shipping_address']['city'] = $this->request->post['city'];
					...
					}  else
					{
						...
						$order_data['shipping_fathername'] = '';
				...
				$order_data['birth_date'] = $this->request->post['birth_date'];
			...
			foreach ($products as $product) {
				...
				if (isset($_POST) && !empty($_POST))
				{
					...
					if ($this->cart->hasShipping()) {
						...
						$data['shipping_fathername'] = $shipping_address['fathername'];
