...
class ControllerProductSearch extends Controller {
	public function index() {
		...
		}elseif (isset($query_parts['search'])){
			$search = $query_parts['search'];
			$this->request->get['search']= $search;
		}
		else {
			$search = '';
		}
		$this->log->debug("ccc ".$search);
		
		$url_parts = parse_url($_SERVER["REQUEST_URI"]);
		parse_str($url_parts['query'], $query_parts);
		//var_dump($query_parts);
		//$this->log->debug(serialize($query_parts));
		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			...
			//$this->log->debug(serialize($filter_data));
